            ...
            children: [
              ...
              VerticalCard(
                ...
                message: Column(
                  ...
                  children: [
                    Text('Developer at Sunna Entertainment', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 20,),
                    Text('Costa Rica', style: TextStyle(fontSize: fontSize),),
                  ],
                ),
              ),
              SizedBox(
              ...
              VerticalCard(
                ...
                message: Text('Fidélitas University, Costa Rica', style: TextStyle(fontSize: fontSize),),
              ),
              SizedBox(
                height: 20,
              ),
              ...
              VerticalCard(
                ...
                message: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('- HTML, CSS, BOOTSTRAP, JS & JQUERY', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 15,),
                    Text('- C#, JAVA & DART', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 15,),
                    Text('- FLUTTER & ASP.NET', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 15,),
                    Text('- UNITY 3D & PHOTOSHOP', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 15,),
                    Text('- SQL, PL/SQL & NoSQL', style: TextStyle(fontSize: fontSize),),
                  ],
                ),
              ),
              SizedBox(
              ...
              VerticalCard(
                ...
                title: 'Photographer',
                message: Text('The secret is to find beauty anywhere', style: TextStyle(fontSize: fontSize),),
              ),
              SizedBox(
                height: 20,
              ),
              ...
              VerticalCard(
                ...
                message: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Out there is a whole world waiting for me', style: TextStyle(fontSize: fontSize),),
                    SizedBox(height: 15,),
                    Text('I\'ve been in Costa Rica, Panamá, México & USA', style: TextStyle(fontSize: fontSize),),
                  ],
                ),
              ),
              SizedBox(
              ...
              VerticalCard(
                ...
                title: 'Gamer',
                message: Text('Life is a game, Play It!', style: TextStyle(fontSize: fontSize),),
              ),
              SizedBox(
                height: 50,
              ),
