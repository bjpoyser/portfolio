...
import 'frienemies_content_desktop.dart';
import 'frienemies_content_mobile.dart';


class FrienemiesView extends StatefulWidget {
  @override
  _FrienemiesViewState createState() => _FrienemiesViewState();
}

class _FrienemiesViewState extends State<FrienemiesView> {
      ...
      body: Column(
        children: [
          Expanded(
            ...
            desktop: FrienemiesContentDesktop(),
            mobile: FrienemiesContentMobile(),
          ))
        ],
      ),
