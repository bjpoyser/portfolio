...
class SMOContentMobile extends StatefulWidget {
  @override
  _SMOContentMobileState createState() => _SMOContentMobileState();
}

class _SMOContentMobileState extends State<SMOContentMobile> {
  @override
