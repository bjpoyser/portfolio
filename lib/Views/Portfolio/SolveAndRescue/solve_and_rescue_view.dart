...
import 'solve_and_rescue_content_desktop.dart';
import 'solve_and_rescue_content_mobile.dart';
import 'solve_and_rescue_content_tablet.dart';

class SolveAndRescueView extends StatefulWidget {
  @override
  _GuardianState createState() => _GuardianState();
}

class _GuardianState extends State<SolveAndRescueView> {
      ...
      body: Column(
        children: [
          Expanded(
            ...
            desktop: SolveAndRescueContentDesktop(),
            mobile: SolveAndRescueContentMobile(),
            tablet: SolveAndRescueContentTablet(),
          ))
        ],
      ),
