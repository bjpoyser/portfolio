...
class PCEContentDesktop extends StatefulWidget {
  @override
  _PCEContentDesktopState createState() => _PCEContentDesktopState();
}

class _PCEContentDesktopState extends State<PCEContentDesktop> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          'This game received very good comments in the GDC 2022, having an article in',
                          style: TextStyle(fontSize: Global.subtitleFontSize),
                        ),
                        Row(
                          children: [
