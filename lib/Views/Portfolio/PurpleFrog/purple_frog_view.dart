...
import 'package:portfolio/Views/Portfolio/PurpleFrog/purple_frog_content_tablet.dart';
import 'package:responsive_builder/responsive_builder.dart';
import 'purple_frog_content_desktop.dart';
import 'purple_frog_content_mobile.dart';
import 'purple_frog_content_tablet.dart';

class PurpleFrogView extends StatefulWidget {
  @override
  _PurpleFrogViewState createState() => _PurpleFrogViewState();
}

class _PurpleFrogViewState extends State<PurpleFrogView> {
      ...
      body: Column(
        children: [
          Expanded(
            ...
            desktop: PurpleFrogContentDesktop(),
            mobile: PurpleFrogContentMobile(),
            tablet: PurpleFrogContentTablet(),
          ))
        ],
      ),
