...
import 'dancejam_content_mobile.dart';

class DanceJamView extends StatefulWidget {
  @override
  _DanceJamState createState() => _DanceJamState();
}

class _DanceJamState extends State<DanceJamView> {
